...
interface NegativeModalProps {
    isNegativeModalOpen: boolean;
    handleNegativeOk: () => void;
}

const NegativeModal: React.FC<NegativeModalProps> = ({ isNegativeModalOpen, handleNegativeOk }) => {
    return (
        <Modal
